...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      //
      navigator.toReplacement('support');
      await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      checkSubMenu2(null);
      //
      navigator.toReplacement('/dashboard/invoices');
      await tester.pumpAndSettle();
      checkMainMenu(dashboard);
      checkSubMenu1(invoices);
      checkSubMenu2(daily);
      //
      // navigator.toReplacement('/dashboard/team');
      // await tester.pumpAndSettle();
      // checkMainMenu(dashboard);
      // checkSubMenu1(team);
      // checkSubMenu2(null);
      ...
      navigator.toReplacement('/dashboard');
      await tester.pumpAndSettle();
      checkMainMenu(dashboard);
      checkSubMenu1(home);
      checkSubMenu2(null);
